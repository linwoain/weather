...
public class SimpleSideDrawer extends FrameLayout {
	...
	/**
	 * <p>
	 * The default Interpolator of drawer animation is
	 * DecelerateInterpolator(9.9).
	 * </p>
	 * <p>
	 * The default animation duration is 230msec.
	 * </p>
	 * 
	 * @see SimpleNavDrawer( android.app.Activity act,
	 *      android.view.animation.Interpolator ip, int duration);
	 * @param act
	 */
	...
	public SimpleSideDrawer(Activity act, Interpolator ip, int duration) {
		...
		final int fp = LayoutParams.MATCH_PARENT;
	...
	/**
	 * <p>
	 * Set the behind view layout.
	 * </p>
	 * <p>
	 * Call this method after setting the main content view by calling
	 * setContentView().
	 * </p>
	 * 
	 * @param <p>
	 *        <b>leftBehindLayout</b>: The layout id, under the res/layout
	 *        directory, which is displayed left side.
	 *        </p>
	...
	/**
	 * <p>
	 * Set the left behind view layout.
	 * </p>
	 * <p>
	 * Call this method after setting the main content view by calling
	 * setContentView().
	...
	/**
	 * <p>
	 * Set the right behind view layout.
	 * </p>
	 * <p>
	 * Call this method after setting the main content view by calling
	 * setContentView().
	 ...
	 * 
	 * @param msec
	 *            The duration time should be milli-second
	 ...
	 * 
	 * @param msec
	 *            The duration time should be milli-second ( default = 180 )
	 */
	...
	/**
	 * If the behind view is opened, close it. If the behind view is closed,
	 * open it.
	 * 
	...
	/**
	 * If the left behind view is opened, close it. If the left behind view is
	 * closed, open it.
	 */
	...
	/**
	 * If the right behind view is opened, close it. If the left behind view is
	 * closed, open it.
	 */
	...
	/**
	 * Need to adjust the behind view height {@hide}
	 */
	...
	/**
	 * Overlay view only when the behind menu is appeared. This view control
	 * scrolling the above view
	 * 
	 * @author Masahiko Adachi
	 */
